...
function initImagini(){
  var continut = fs.readFileSync(path.join(__dirname, "Resurse/json/galerie.json")).toString("utf-8");
    ...
    // Creăm folderele pentru poze medii și mici dacă nu există
    ...
    for (let imag of vImagini) {
        ...
        // Generăm pozele mici și medii doar dacă nu au fost deja generate
        ...
        // Salvăm căile relative pentru HTML (înlocuim .jpg cu .webp pentru mediu/mic)
